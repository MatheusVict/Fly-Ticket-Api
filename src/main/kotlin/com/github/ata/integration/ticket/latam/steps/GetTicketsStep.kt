...
class GetTicketsStep(
    ...
    fun doRequest(request: LatamTicketRequest, cookies: String): StepResponse {
        ...
        return httpClient.get(
            url = Constants.BASE_SERVICE_URL + ENDPOINT + queryParams,
            headers = headers
        ).toStepResponse()
    }
